...
return {
  ...
  usage = {
    'قفل ربات ها روشن: Enable Anti-bot on current chat',
    'قفل ربات ها خاموش: Disable Anti-bot on current chat',
    'قفل ربات ها همیشه <botId>: Allow <botId> on this chat',
    'قفل ربات ها هیچ وقت <botId>: Disallow <botId> on this chat'
  },
  patterns = {
    '^قفل ربات ها (همیشه) (%d+)$',
    '^قفل ربات ها (هیچ وقت) (%d+)$',
    '^قفل ربات ها (روشن)$',
    '^قفل ربات ها (خاموش)$',
